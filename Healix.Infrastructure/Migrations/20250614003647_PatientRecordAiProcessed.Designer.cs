...
namespace Healix.Infrastructure.Migrations
{
    ...
    [Migration("20250614003647_PatientRecordAiProcessed")]
    partial class PatientRecordAiProcessed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoctorCertificate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FamilySummary", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("FamilySummaries", (string)null);
                });
            ...
            modelBuilder.Entity("Healix.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<Guid>("PatientSummaryId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Healix.Domain.Entities.FamilyGroup", b =>
                {
                    ...
                    b.Property<Guid>("FamilySummaryId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PatientSummary", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PatientSummaries", (string)null);
                });
            ...
            modelBuilder.Entity("FamilySummary", b =>
                {
                    b.HasOne("Healix.Domain.Entities.FamilyGroup", "Family")
                        .WithOne("FamilySummary")
                        .HasForeignKey("FamilySummary", "FamilyId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("PatientSummary", b =>
                {
                    b.HasOne("Healix.Domain.Entities.ApplicationUser", "Patient")
                        ...
                        .HasForeignKey("PatientSummary", "PatientId")
                        .OnDelete(DeleteBehavior.NoAction);
